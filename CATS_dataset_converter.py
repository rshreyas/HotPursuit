...
def crop_images_and_save(path_to_images, save_dir_path, square_size, algo_name = 'pix2pix'):
    ...
    if algo_name == 'pix2pix':
        ...
        pairwise_resize_and_join(path_to_images, left_thermal, left_color, square_size, save_dir_path)
        pairwise_resize_and_join(path_to_images, right_thermal, right_color, square_size, save_dir_path)
